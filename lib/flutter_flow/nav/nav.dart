        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'mainTravels',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Main_Travels')
                  : MainTravelsWidget(),
            ),
            FFRoute(
              name: 'Main_messages',
            ...
            FFRoute(
              name: 'Create_travel',
              path: 'createTravel',
              builder: (context, params) => CreateTravelWidget(),
            ),
            FFRoute(
              name: 'Start',
              path: 'start',
            ...
            FFRoute(
              name: 'Profile_Driver_Passenger',
              path: 'profileDriverPassenger',
              builder: (context, params) => ProfileDriverPassengerWidget(),
            ),
            FFRoute(
              name: 'travelDetails',
              path: 'travelDetails',
              builder: (context, params) => TravelDetailsWidget(
                travelRef: params.getParam(
                  'travelRef',
                  ParamType.DocumentReference,
                  isList: false,
            ...
            FFRoute(
              name: 'Profile_Driver',
              path: 'profileDriver',
              builder: (context, params) => ProfileDriverWidget(),
            ),
            FFRoute(
              name: 'Create_Request',
              path: 'createRequest',
