...
class _TravelDetailWidgetState extends State<TravelDetailWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<RidesRecord>(
      stream: RidesRecord.getDocument(widget.idTravel!),
      builder: (context, snapshot) {
        ...
        final columnRidesRecord = snapshot.data!;
        return Column(
                            ...
                            children: [
                                ...
                                child: StreamBuilder<UsersRecord>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Image.network(
                                      imageUsersRecord.driverInfoCarPhoto,
                                      width: double.infinity,
                                      height: 240.0,
                                      fit: BoxFit.cover,
                              ...
                              Align(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'TRAVEL_DETAIL_COMP_Card_xvm62zsz_ON_TAP');
                                    context.safePop();
                                  },
                                  child: Card(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final listpassengers =
                                      columnRidesRecord.passengers.toList();
                                  return ListView.builder(
                                    padding: EdgeInsets.zero,
                                    primary: false,
                                    shrinkWrap: true,
                                    scrollDirection: Axis.vertical,
                                    itemCount: listpassengers.length,
                                    itemBuilder:
                                        (context, listpassengersIndex) {
