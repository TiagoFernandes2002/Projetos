...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF90D26D);
  late Color secondary = const Color(0xFFFF9800);
  late Color tertiary = const Color(0xFF2C7865);
  late Color alternate = const Color(0xFFE5E7EB);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF34373F);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4D89D8F5);
