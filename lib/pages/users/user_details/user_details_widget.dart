...
class _UserDetailsWidgetState extends State<UserDetailsWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('USER_DETAILS_userDetails_ON_INIT_STATE');
      _model.listchatfilter = await queryChatRecordOnce(
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'USER_DETAILS_PAGE_Card_mloto079_ON_TAP');
                                      context.safePop();
                                    },
                                    child: Card(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'USER_DETAILS_mark_chat_unread_ICN_ON_TAP');
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Visibility(
                                  visible:
                                      columnUsersRecord.driverInfoIsApproved,
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    crossAxisAlignment:
