                                  ...
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<List<RidesRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<RidesRecord>
                                            projectCardRidesRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final projectCardRidesRecord =
                                            projectCardRidesRecordList
                                                    .isNotEmpty
                                                ? projectCardRidesRecordList
                                                    .first
                                        ...
                                        return InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'MAIN_HOME_PAGE_projectCard_ON_TAP');

                                            context.pushNamed(
                                              'travelDetails',
                                              queryParameters: {
                                                'travelRef': serializeParam(
                                                  projectCardRidesRecord
                                                      ?.reference,
