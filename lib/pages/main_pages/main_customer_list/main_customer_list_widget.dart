            ...
            child: Padding(
              ...
              child: AuthUserStreamWidget(
                builder: (context) => FloatingActionButton(
                  onPressed: () async {
                    logFirebaseEvent(
                        'MAIN_CUSTOMER_LIST_FloatingActionButton_');
              ...
              Flexible(
                child: Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(),
                    child: StreamBuilder<List<TravelRequestsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<TravelRequestsRecord>
                            listViewTravelRequestsRecordList = snapshot.data!;
                        return ListView.builder(
                          ...
                          itemCount: listViewTravelRequestsRecordList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewTravelRequestsRecord =
                                listViewTravelRequestsRecordList[listViewIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 8.0, 16.0, 0.0),
                              child: StreamBuilder<UsersRecord>(
                                stream: UsersRecord.getDocument(
                                    listViewTravelRequestsRecord.passengerId!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                          ...
                                          Builder(
                                            builder: (context) => Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'MAIN_CUSTOMER_LIST_Icon_dzeb95dy_ON_TAP');
